...
class CameraCreate(BaseModel):
    ...
    # 👇 INI BARIS YANG HILANG DAN BIKIN KITA PUSING 👇
    stream_url: Optional[str] = None 
    
    # --- Tambahan Pengaturan Garis & AI ---
    line_x1: int = 100
    line_y1: int = 300
    line_x2: int = 500
    line_y2: int = 300
    low_density_threshold: float = 0.40
    high_density_threshold: float = 0.70
    confidence_tolerance: float = 0.50
...
class VirtualLineUpdate(BaseModel):
    """Request schema for updating flexible virtual line (2 points / 4 coordinates)."""
    line_x1: int
    line_y1: int
    line_x2: int
    line_y2: int
